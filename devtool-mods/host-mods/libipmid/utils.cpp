...
{
    log<level::INFO>("INFO: getService enter ");
    auto mapperCall =
    ...
    {
        log<level::INFO>("INFO: getService error in the mapper call");
    ...
    {
        log<level::INFO>("INFO: getService error in the mapper response");
