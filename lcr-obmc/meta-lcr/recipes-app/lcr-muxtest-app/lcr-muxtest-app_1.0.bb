SUMMARY = "MUX test application"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

SRC_URI = "file://src/main.cpp \
           file://src/utils.cpp \
           file://src/lcr_muxtest.cpp \
           file://include/lcr_muxtest.hpp \
...
do_install() {
    install -d ${D}${bindir}
    install -m 0755 muxtest ${D}${bindir}/muxtest
}

PROVIDES = "lcr_muxtest"
RPROVIDES:${PN} = "lcr_muxtest"
