SUMMARY = "Voltage Driver"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

SRC_URI = "file://src/main.cpp \
           file://src/utils.cpp \
           file://src/ADC_manipulation.cpp \
           file://include/ADC_manipulation.hpp \
           file://include/global.hpp \
           file://LCR_ADC_sensors.service"
...
do_compile() {
    ...
    ${WORKDIR}/src/ADC_manipulation.cpp \
    -I ${WORKDIR}/include \
...
do_install() {
    install -d ${D}${bindir}
    install -m 0755 ADCman ${D}${bindir}/ADCman
