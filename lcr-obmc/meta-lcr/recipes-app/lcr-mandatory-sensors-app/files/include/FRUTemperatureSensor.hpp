...
class FRUTemperatureSensor {
    ...
    public: 
        FRUTemperatureSensor(std::shared_ptr<sdbusplus::asio::connection> conn_ref, sdbusplus::asio::object_server& server_ref);
        ~FRUTemperatureSensor();
