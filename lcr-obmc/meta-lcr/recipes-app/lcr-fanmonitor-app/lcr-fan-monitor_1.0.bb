...
SRC_URI = "file://src/main.cpp \
           file://src/utils.cpp \
           file://src/fan_monitor.cpp \
           file://include/fan_monitor.hpp \
           file://include/global.hpp \
           file://LCR_fan_monitor.service"
...
do_install() {
    install -d ${D}${bindir}
    install -m 0755 lcr_fan_monitor ${D}${bindir}/lcr_fan_monitor

    # Install the systemd service file
    install -d ${D}${systemd_system_unitdir}
    install -m 0644 ${WORKDIR}/LCR_fan_monitor.service ${D}${systemd_system_unitdir}/LCR_fan_monitor.service
}


PROVIDES = "lcr_fan_monitor"
RPROVIDES:${PN} = "lcr_fan_monitor"

SYSTEMD_SERVICE:${PN} = "LCR_fan_monitor.service"
