OBMC_IMAGE_EXTRA_INSTALL:append = " mtd-utils"
...
OBMC_IMAGE_EXTRA_INSTALL:append = " lcr_mux"
OBMC_IMAGE_EXTRA_INSTALL:append = " lcr_muxtest"
...
OBMC_IMAGE_EXTRA_INSTALL:append = " LCR_KX_config"
OBMC_IMAGE_EXTRA_INSTALL:append = " iperf3"
OBMC_IMAGE_EXTRA_INSTALL:append = " lcr_fan_monitor"
OBMC_IMAGE_EXTRA_INSTALL:append = " lcr-fanctl"
OBMC_IMAGE_EXTRA_INSTALL:append = " phosphor-sel-logger"
OBMC_IMAGE_EXTRA_INSTALL:append = " lcr_payload"
OBMC_IMAGE_EXTRA_INSTALL:append = " minicom"
OBMC_IMAGE_EXTRA_INSTALL:append = " screen"
