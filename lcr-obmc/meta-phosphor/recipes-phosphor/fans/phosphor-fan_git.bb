...
DEPENDS += "virtual/phosphor-fan-control-events-config"
DEPENDS += "virtual/phosphor-fan-control-zone-conditions-config"
...
PACKAGECONFIG[cooling-type] = "-Dcooling-type-service=enabled,,,"
# --------------------------------------
